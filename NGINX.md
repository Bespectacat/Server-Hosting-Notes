...
As nifty as this is, there are some inherent limitations to keep in mind that I've faced personally. The main limitation I've faced is that any and all traffic going through the VPN tunnel will likely be masqueraded to be read as your VPN's IP and not as the client's IP (of whom is connecting to your services). Of course, I could just host my services on a VPS or three and call it a day...
